...
#     # Assuming you have a list of patients and doctors
#     patient_ids = [patient.id for patient in patients]
#     doctor_ids = [doctor.id for doctor in doctors]

#     #   To ensure the appointments are within the range of available patients and doctors
...
#     reason=rc(appointment_reasons),
#     # Use current time or specify a datetime
#     date_time=fake.date_time_this_year(before_now=True, after_now=False),
...
#              name=fake.name(),
#             email=fake.email(),
#             # Use a strong password generator for production
#             password=fake.password(length=10),
#             phone_number=fake.phone_number()
#         )
#     admins.append(admin)
...
with app.app_context():
    ...
    # Uncomment and modify the following lines if you need a specific admin user
    # specific_password = bcrypt.generate_password_hash("janepassword123").decode('utf-8')
    # specific_admin = Admin(
    #     name="Jane Doe",
    #     email="jane.doe@example.com",
